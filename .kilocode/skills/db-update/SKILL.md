...
```powershell
powershell.exe -NoProfile -File ".kilocode/skills/db-update/scripts/db-update.ps1" <параметры>
```
...
powershell.exe -NoProfile -File ".kilocode/skills/db-update/scripts/db-update.ps1" -InfoBasePath "C:\Bases\MyDB" -UserName "Admin"

# Динамическое обновление
powershell.exe -NoProfile -File ".kilocode/skills/db-update/scripts/db-update.ps1" -InfoBaseServer "srv01" -InfoBaseRef "MyDB" -UserName "Admin" -Password "secret" -Dynamic on

# Обновление расширения
powershell.exe -NoProfile -File ".kilocode/skills/db-update/scripts/db-update.ps1" -InfoBasePath "C:\Bases\MyDB" -UserName "Admin" -Extension "МоёРасширение"
```
