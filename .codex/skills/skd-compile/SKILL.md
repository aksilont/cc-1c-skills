...
```powershell
# Из файла
python ".codex/skills/skd-compile/scripts/skd-compile.py" -DefinitionFile "<json>" -OutputPath "<Template.xml>"

# Из строки (без промежуточного файла)
python ".codex/skills/skd-compile/scripts/skd-compile.py" -Value '<json-string>' -OutputPath "<Template.xml>"
```
