...
```powershell
python ".cursor/skills/db-update/scripts/db-update.py" <параметры>
```
...
python ".cursor/skills/db-update/scripts/db-update.py" -InfoBasePath "C:\Bases\MyDB" -UserName "Admin"

# Динамическое обновление
python ".cursor/skills/db-update/scripts/db-update.py" -InfoBaseServer "srv01" -InfoBaseRef "MyDB" -UserName "Admin" -Password "secret" -Dynamic on

# Обновление расширения
python ".cursor/skills/db-update/scripts/db-update.py" -InfoBasePath "C:\Bases\MyDB" -UserName "Admin" -Extension "МоёРасширение"
```
