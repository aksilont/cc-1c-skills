# 1C Skills for Augment (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Augment** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.augment/skills/`.
3. Запустите Augment из этого проекта — навыки станут доступны.
