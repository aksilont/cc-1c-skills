# 1C Skills for OpenCode (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **OpenCode** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.opencode/skills/`.
3. Запустите OpenCode из этого проекта — навыки станут доступны.
