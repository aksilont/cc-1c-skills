# 1C Skills for Gemini CLI (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Gemini CLI** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.gemini/skills/`.
3. Запустите Gemini CLI из этого проекта — навыки станут доступны.
...
Build commit: `fddaca37e7ca1054be980e7438f2f71330540fd3`
