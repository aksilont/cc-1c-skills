# 1C Skills for Cline (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Cline** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.cline/skills/`.
3. Запустите Cline из этого проекта — навыки станут доступны.
