...
Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Agent Skills** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.agents/skills/`.
3. Запустите Agent Skills из этого проекта — навыки станут доступны.
