# 1C Skills for Kilo Code (Python)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Kilo Code** с рантаймом **Python**.
