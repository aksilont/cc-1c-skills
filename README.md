# 1C Skills for Codex (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Codex** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.codex/skills/`.
3. Запустите Codex из этого проекта — навыки станут доступны.
