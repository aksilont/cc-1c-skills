# 1C Skills for Yandex Code Assistant (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Yandex Code Assistant** с рантаймом **PowerShell**.
