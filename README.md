# 1C Skills for Windsurf (PowerShell)

Автоматическая сборка из [main](https://github.com/aksilont/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Windsurf** с рантаймом **PowerShell**.
...
2. Распакуйте в корень своего проекта — должна появиться папка `.windsurf/skills/`.
3. Запустите Windsurf из этого проекта — навыки станут доступны.
